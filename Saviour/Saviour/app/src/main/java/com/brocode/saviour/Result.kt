...
class Result(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    private fun getSortedResult(labelProbArray: Array<FloatArray>): List<Recognition> {
        Log.d("Result", "List Size:(%d, %d, %d)".format(labelProbArray.size,labelProbArray[0].size,LABEL_LIST.size))
        ...
        Log.d("Result", "pqsize:(%d)".format(pq.size))
